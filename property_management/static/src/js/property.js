odoo.define('property_management.property_search', function (require) {
    'use strict';
    ...
    publicWidget.registry.property_search = publicWidget.Widget.extend({
        ...
        start() {
            $("#snippet_real_state_op").empty();
            $("#snippet_property_type_id").empty();
            ...
            this._rpc({
                route: '/website/real_state_types',
                params: {}
            }).then((res) => {
                $.each(res, function (key, value) {
