...
class PropertyManagementAmb(models.Model):
    ...
    _sql_constraints = [('name_uniq', 'unique (name)', _("El Ambiente ingresado ya se encuentra registrado en el sistema."))]
    ...
    def fields_get(self, fields=None):
        ...
        res = super(PropertyManagementAmb, self).fields_get()
