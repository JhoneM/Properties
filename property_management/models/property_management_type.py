...
class PropertyManagementType(models.Model):
    ...
    _sql_constraints = [('name_uniq', 'unique (name)', _("El Tipo de Propiedad ingresado ya se encuentra registrado en el sistema."))]
    ...
    def fields_get(self, fields=None):
        ...
        res = super(PropertyManagementType, self).fields_get()
